...
def write():
    ...
    with st.spinner("Loading Home ..."):
        st.markdown('<h4 style="text-align: center; font-family: cursive; color: rgb(255, 127, 39)"><b>WELCOME TO THE INFANT DEATH ANALYSIS APPLICATION</b></h4>', unsafe_allow_html=True)
        st.markdown('<h6 style="text-align: center; color: #d9534f"><b> <i><u>DSEN-1-A, 2022 </u></i> </b></h6>', unsafe_allow_html=True)
